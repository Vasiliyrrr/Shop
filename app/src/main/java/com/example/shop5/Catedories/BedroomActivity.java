    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent loginIntent = new Intent(BedroomActivity.this, HomeActivity.class);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(BedroomActivity.this, CartActivity.class);
                startActivity(loginIntent);
            }
        });
        ...
        favorites.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(BedroomActivity.this, FavoritesActivity.class);
                startActivity(loginIntent);
            }
        });
        ...
        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(BedroomActivity.this, ProfileActivity.class);
                startActivity(loginIntent);
            }
        });
    }
