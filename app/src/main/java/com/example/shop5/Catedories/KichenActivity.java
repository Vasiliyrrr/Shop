...
public class KichenActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        home.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent loginIntent = new Intent(KichenActivity.this, HomeActivity.class);
        ...
        cart.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(KichenActivity.this, CartActivity.class);
                startActivity(loginIntent);
            }
        });
        ...
        favorites.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(KichenActivity.this, FavoritesActivity.class);
                startActivity(loginIntent);
            }
        });
        ...
        user.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent loginIntent = new Intent(KichenActivity.this, ProfileActivity.class);
                startActivity(loginIntent);
            }
        });
    }
